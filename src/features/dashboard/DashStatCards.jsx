...
export default memo(function DashStatCards({ STUDENT, STEPS, navTarget = '/app' }) {
  ...
  return (
    <div
      ref={rowRef}
      style={{ ...revealStyle(rowVisible), background: 'var(--bg-card)' }}
      className="rounded-2xl border border-slate-800/80 p-5 md:p-8 mb-5 md:mb-7 flex flex-col sm:flex-row items-center gap-5 sm:gap-7"
    >
