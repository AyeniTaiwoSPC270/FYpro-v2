  ...
  return (
    ...
    >
      <div
        ...
        className="rounded-2xl border border-slate-800/80 p-5 md:p-8 flex flex-col sm:flex-row items-stretch sm:items-center gap-4 sm:gap-7"
      >
        {/* On mobile the ring sits inline beside the text; sm:contents dissolves this
            wrapper so ring and text become direct children of the row on desktop. */}
        <div className="flex items-center gap-4 sm:contents">
          <div className="relative flex items-center justify-center flex-shrink-0 w-[44px] h-[44px] sm:w-[66px] sm:h-[66px]">
            <svg
              viewBox="0 0 66 66" className="w-full h-full" style={{ transform: 'rotate(-90deg)' }}
            ...
            <div className="absolute font-mono font-bold text-white text-[0.7rem] sm:text-[0.88rem]">{completed}/{total}</div>
          </div>
          ...
          <div className="flex-1 min-w-0 text-left">
            ...
            <p className="font-sans text-[0.8rem] leading-[1.55] max-w-[48ch] text-slate-500">
        ...
        <motion.button
          ...
          className="inline-flex items-center justify-center gap-2 w-full sm:w-auto min-h-[48px] px-6 py-3 bg-green-600 hover:bg-green-500 text-white border-0 rounded-xl font-sans text-[0.82rem] font-semibold cursor-pointer flex-shrink-0"
        >
