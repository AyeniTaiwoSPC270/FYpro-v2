  ...
  if (!qualifies) {
    return (
      <div style={{
        ...
        boxShadow:    isLight ? '0 4px 20px rgba(0,0,0,0.06), 0 1px 6px rgba(0,0,0,0.04)' : '0 4px 20px rgba(0,0,0,0.4), 0 1px 6px rgba(0,0,0,0.2)',
        margin:       '24px 0',
        ...
        <div>
          ...
          <p style={{
            ...
            fontSize:   '0.875rem',
            color:      isLight ? 'rgba(13,27,42,0.65)' : 'rgba(255,255,255,0.7)',
            lineHeight: 1.6,
            margin:     0,
          }}>
