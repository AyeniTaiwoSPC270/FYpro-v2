      ...
      <main className="pt-[66px]">
        ...
        <section className="pt-24 pb-16 text-center">
          <div className="max-w-4xl mx-auto px-6">
            <Reveal>
              <span className="font-mono text-xs uppercase tracking-widest text-blue-400">Release Notes</span>
            </Reveal>
            <Reveal delay={0.05}>
        ...
        <section className="max-w-[720px] mx-auto px-6 pb-24">
          ...
          {changelog.length === 0 && (
            <Reveal>
              <p className="font-sans text-sm text-slate-600 text-center mt-12">
