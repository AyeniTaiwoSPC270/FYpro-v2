              ...
              <div className="flex flex-row gap-6 items-start">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="font-sans text-slate-400 text-sm mt-3 leading-relaxed">
                    I watched senior students panic every semester — not because they weren't smart, but because there was no structured support between supervisor meetings. I built FYPro to change that.
                  </p>
                  <p className="font-sans text-slate-400 text-sm mt-2 leading-relaxed">
                    FYPro is purpose-built for Nigerian university students. It understands UNILAG faculty structures, Nigerian research contexts, and the specific stress of FYP season. This isn't a general AI tool — it's built for one thing: helping you survive and excel at your final year project.
                  </p>
                  <a
                    href="https://wa.me/2348029061967"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="inline-flex items-center gap-1.5 font-sans text-xs text-green-400 mt-3 no-underline hover:text-green-300 transition-colors duration-150"
                  >
                    ...
                    Questions? WhatsApp +234 802 906 1967
                  </a>
                </div>
              </div>
            </div>
