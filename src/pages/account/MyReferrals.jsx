...
export default function MyReferrals() {
  ...
  return (
    <div style={{ minHeight: '100vh', background: pageBg, backgroundImage: `radial-gradient(circle, ${dotColor} 1.5px, transparent 1px)`, backgroundSize: '28px 28px', padding: '40px 20px' }}>
