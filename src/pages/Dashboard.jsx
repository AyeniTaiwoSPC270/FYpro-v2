...
function UsageBar({ used, limit }) {
  ...
  if (limit === null) {
    return (
      <div className="flex items-center gap-2 mt-[6px]">
        ...
        />
        <span
          className="font-mono text-[0.58rem] text-green-400 tracking-[0.06em] uppercase flex-shrink-0"
  ...
  return (
    <div className="flex items-center gap-2 mt-[6px]">
      ...
      <span
        className="font-mono text-[0.6rem] flex-shrink-0"
        style={{ color: usageBarColor(pct), minWidth: 48, textAlign: 'right' }}
      >
        {used} / {limit}
      </span>
    </div>
    ...
    >
      ...
      <div className="flex items-center justify-between mb-6">
        <div>
          ...
          <div className="font-sans text-[0.73rem] text-slate-500">
            Limits reset when you start a new project.
          </div>
        </div>
        <span
          ...
          return (
            <div key={key}>
              <div className="flex items-center justify-between">
                <span className="font-sans text-[0.82rem] font-medium text-white">
                  {USAGE_FEATURE_LABELS[key]}
                </span>
                {limit !== null && (
                  <span
                    className="font-mono text-[0.6rem] text-slate-500"
                  >
      ...
      {planKey === 'free' && (
        ...
        >
          ...
          <a
            href="/pricing"
            className="font-sans text-[0.74rem] font-semibold text-blue-400 hover:text-blue-300 no-underline flex-shrink-0 transition-colors duration-150"
          >
            Upgrade →
          </a>
        </div>
