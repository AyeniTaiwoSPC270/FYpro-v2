...
function ShieldIcon({ size = 20, ...rest }) {
  return (
    <img src="/fypro-logo.png" alt="FYPro" width={size} height={size} aria-hidden="true" {...rest} />
  )
}
...
const FEATURES = [
  {
    ...
    icon: <img src="/fypro-logo.png" alt="FYPro" width="20" height="20" />,
